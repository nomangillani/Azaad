...
public class PendingItemsAdapters extends ArrayAdapter<InboxDataClass> {
    ...
    public PendingItemsAdapters(Activity thecontext, ArrayList<InboxDataClass> thedata) {
        super(thecontext, R.layout.pendingitem, thedata);
    ...
    public View getView(final int position, View rowview, ViewGroup viewGroup) {
        ...
        if (rowview == null) {
            ...
            rowview = inflater.inflate(R.layout.pendingitem, null, false);
